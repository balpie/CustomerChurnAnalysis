...
def upload():
    ...
    joblib.dump(pipeline, SCRIPT_DIR / "../../models/sgdc/churn_pipeline_sgdc_log_loss.joblib")

    #label_encoder e feature columns sono gli stessi
    ...
    print("\nModello salvato in: ../../models/sgdc/churn_pipeline_sgdc_log_loss.joblib")
